...
def trx_check(current_shopper: Shopper):
    ...
    response = {
            ...
            "label" : current_shopper.label,
            "NOF_total" : current_trasnaction.connect_dwh_get_fraud()[0],
...
if __name__ == "__main__":
    uvicorn.run("server_pushed:app", host="127.0.0.1", port=8000, reload=True, log_level='trace')
